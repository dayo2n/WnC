...
import com.springweb.web.controller.dto.file.UploadFileDto;
import com.springweb.web.controller.dto.member.SimpleTeacherDto;
...
public class LessonDetailDto {
    ...
    private LessonType lessonType; //과외 타입ALL , PERSONAL, GROUP
    ...
    public LessonDetailDto(Lesson findLesson) {
        ...
        this.recommendCount     =findLesson.getRecommendCount();
